  ...
  return (
    <section id="quote" className="py-24 lg:py-36">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="reveal relative overflow-hidden rounded-3xl bg-card border border-border px-8 py-20 lg:px-20 lg:py-32 text-center">
          ...
          <div className="relative">
            <h2 className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold text-card-foreground text-balance max-w-3xl mx-auto">
